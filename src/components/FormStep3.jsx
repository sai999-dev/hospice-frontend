    ...
    <>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[#62708d] mb-4 text-[14px]">
          A licensed healthcare professional will contact you personally
        </p>
        <div className="bg-[rgba(34,197,94,0.08)] text-[#22c55e] px-5 py-3 rounded-full text-[12px] font-[550] border border-[rgba(34,197,94,0.3)] inline-block">
          Schedule your free consultation with a hospice specialist
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        />
        {errors.first_name && (
          <div className="text-[#dc2626] text-[12px] mt-1 flex items-center gap-1">
            {errors.first_name}
          </div>
        )}
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            <label
              key={option.value}
              className="flex items-center gap-3 px-4 py-3 border-2 border-[rgba(94,82,64,0.2)] rounded-lg cursor-pointer transition-all duration-150 ease-[cubic-bezier(0.16,1,0.3,1)] bg-[#fcfcfa] hover:border-[#2185a1] hover:bg-[rgba(59,130,246,0.08)]"
            >
              <input
                type="radio"
                name="best_time"
